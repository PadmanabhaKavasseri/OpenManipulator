...
void find_min(rs2_frame* frame,rs2_error* e, int max_height, int max_width){
    int x,y = 0;
    ...
    for(int h = 0; h < max_height; h++){
        for(int w = 0; w < max_width; w++){
            float curr_dist = rs2_depth_frame_get_distance(frame,w,h,&e);
            check_error(e);
